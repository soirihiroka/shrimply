...
use shrimply_components_skia::canvas::{Align2, FontId, Rect, Stroke, TimelinePainter, Vec2, vec2};
use shrimply_math_color::Color;
use shrimply_preview_provider_skia::PreviewViewport;
use shrimply_project_document::project::CanvasSize;
use shrimply_project_document::project::{PreviewGuides, Project};
...
pub fn commit_edit(project: &Project) {
    shrimply_project_document::project::commit_edit(project, "preview-guide");
}
