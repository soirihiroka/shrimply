use super::*;
use shrimply_timeline_skia::scene::{Event, PointerButton};

use shrimply_components_gtk::{cursor::software_cursor_from_name, ui::PointerLock};
...
pub(crate) fn add_input_controllers(
    ...
    shrimply_components_gtk::pinch_zoom::connect_pinch_zoom(
        area,
        {
        ...
        },
        {
            ...
            move |(x, y), magnification| {
                runtime
                    .borrow_mut()
                    .scene
                    .magnify(vec2(x as f32, y as f32), magnification);
            }
        },
    );
