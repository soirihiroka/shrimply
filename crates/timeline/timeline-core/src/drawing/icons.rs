...
pub use shrimply_skia_adw_core::icon::Icon;
pub fn draw_track_toggle_icon(
...
pub fn draw_icon(painter: &TimelinePainter, rect: Rect, icon: Icon, color: Color) {
...
pub fn draw_item_icon(painter: &TimelinePainter, item_rect: Rect, icon: Icon, color: Color) {
