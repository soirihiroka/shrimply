...
pub fn item_group_id(project: &Project, key: ItemKey) -> Option<u64> {
...
pub fn set_item_address_group_id(
    project: &mut Project,
    address: &ItemAddress,
    group_id: Option<u64>,
) -> bool {
...
pub fn expand_grouped_item_addresses(
...
pub fn fold_items(project: &mut Project, selected_items: &[ItemKey]) -> Option<Vec<ItemKey>> {
...
pub fn expand_grouped_selection(project: &Project, selection: &[ItemKey]) -> Vec<ItemKey> {
