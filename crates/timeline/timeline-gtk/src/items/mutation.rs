...
pub(crate) trait OverwriteItem: Clone + TimeSlice {
...
pub(crate) fn overwrite_caption_items(
    project: &mut Project,
...
pub(crate) fn overwrite_video_items(
    project: &mut Project,
    placements: &[ItemPlacement],
    new_track_indices: &[usize],
) -> Option<()> {
...
pub(crate) fn overwrite_audio_items(
    project: &mut Project,
    placements: &[ItemPlacement],
    new_track_indices: &[usize],
) -> Option<()> {
...
pub(crate) fn overwrite_items<T: OverwriteItem>(items: &mut Vec<T>, start: Time, end: Time) {
    let mut index = 0;
...
pub(crate) fn remove_caption_items(
    project: &mut Project,
    placements: &[ItemPlacement],
) -> Option<()> {
...
pub(crate) fn remove_video_items(
    project: &mut Project,
    placements: &[ItemPlacement],
) -> Option<()> {
    let mut keys: Vec<_> = placements
...
pub(crate) fn remove_audio_items(
    project: &mut Project,
    placements: &[ItemPlacement],
) -> Option<()> {
    let mut keys: Vec<_> = placements
